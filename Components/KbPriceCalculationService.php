 ...
 */
class KbPriceCalculationService implements Service\PriceCalculationServiceInterface
{
    /**
     ...
     */
    public function __construct(Service\PriceCalculationServiceInterface $service)
    {
